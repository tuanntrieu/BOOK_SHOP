  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().configurationSource(request -> corsConfiguration())
        ...
        .authorizeRequests()
            ...
            .antMatchers("/api/v1/product/get-products", "/api/v1/product/get-product-detail","/api/v1/category/get-categories","/api/v1/find-product","/api/v1/get-products-sort-by-total","/api/v1/banner/get-banners","api/v1/customer/get-by-user").permitAll()
